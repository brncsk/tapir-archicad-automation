...
static void FillNewStoryCmd (const GS::Array<GS::ObjectState>& stories, const GS::UIndex storyPos, API_StoryCmdType& storyCmd)
{
    ...
    GS::ucscpy (storyCmd.uName, name.ToUStr (0, GS::Min (name.GetLength (), (USize) API_UniLongNameLen - 1)).Get ());
}
...
GS::Optional<GS::UniString> IFCFileOperationCommand::GetInputParametersSchema () const
{
    return R"({
        ...
        "properties": {
            ...
            "elementsToExport": {
                "type": "string",
                "description": "Only for the save method with a translatorName: which elements to export. The default is VisibleElementsOnAllStories.",
